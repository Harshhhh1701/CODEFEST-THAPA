  ...
  return (
    <>
      <div className="flex justify-center relative">
        ...
        <div className="absolute text-blue-500 left-[20rem] top-12 bg-white p-5 rounded-3xl shadow-2xl shadow-cyan-500/50">
          <FaReact size={100} />
        </div>
        <div className="absolute text-blue-500 right-[20rem] top-28 bg-white p-5 rounded-3xl shadow-2xl shadow-cyan-500/50">
          <FaNodeJs size={80} />
        </div>
      </div>
