...
const HeroSection = () => {
    return (
        <div className="h-screen w-screen  grid grid-cols-2 items-center justify-items-center">
            <div className="ml-28">
                <h1 className="text-7xl font-bold uppercase relative text-indigo-900 tracking-wider text-shadow-md">Grow your career with Quality Education
            ...
            <div className="flex h-full justify-center relative">
                <img src={Hero} alt="Hero" className="object-cover image" />
                <div className="absolute inset-28 bg-blue-800 rounded-full blur-[80px] opacity-40" />
                <motion.div initial={{ opacity: 0, x: -50 }} animate={{
                    opacity: 1,
                    x: 0,
                    transition: {
                        delay: 1,
